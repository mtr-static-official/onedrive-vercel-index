/**
* 此文件包含用于自定义网站配置的信息，例如共享的文件夹、标题、使用的Google字体、网站图标、联系方式等。
 */
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'mtr@cartazhixin.onmicrosoft.com',
